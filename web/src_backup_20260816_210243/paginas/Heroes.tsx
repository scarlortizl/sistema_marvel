        ...
        <div className="hero-carousel">
          ...
          <div className="hero-carousel__caption">
            ...
            <div className="hero-carousel__caption-top">
              ...
              <span className="hero-carousel__caption-power">
                POWER {heroeActivo?.nivel_poder}/100
              </span>
            </div>
            ...
            <div className="hero-carousel__caption-actions">
              <Link className="button button--primary hero-carousel__cta" to={`/heroes/${heroeActivo?.id}`}>
                Ver perfil
              </Link>
              ...
              {esAdmin && heroeActivo && (
                <>
                  <Link
                    ...
                    to={`/heroes/${heroeActivo.id}/editar`}
                    aria-label={`Editar ${heroeActivo.nombre}`}
                  >
                    <EditIcon />
                  </Link>
                  <button
                    className="icon-button icon-button--danger"
                    onClick={() => setAEliminar(heroeActivo)}
                    aria-label={`Eliminar ${heroeActivo.nombre}`}
                  >
                    <TrashIcon />
                  </button>
                </>
