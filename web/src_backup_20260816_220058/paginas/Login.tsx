  ...
  return (
    <div className="login login--v2">
      ...
      <aside className="login__story">
        <div className="login__story-brand">
          <img src={marvelLogo} alt="Marvel" className="login__story-brand-logo" />
          <span>HERO CONTROL SYSTEM</span>
        </div>

        <p className="micro-label">MARVEL CONTROL NETWORK</p>
      ...
      <form className="login__caja login__caja--v2" onSubmit={enviar}>
        ...
        <div className="login__brand login__brand--minimal">
